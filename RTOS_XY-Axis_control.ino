/*
 * ESP32 Dual-Core FreeRTOS One-Axis Motor Controller
 * 
 ...
 *   - Resolution: 5 steps/mm at full step
 * 
 * Pin Configuration:
 *   STEP_PIN  = GPIO18
 *   DIR_PIN   = GPIO19
 *   ENABLE tied to GND
 *   SLEEP/RESET tied to 3.3V
 * 
 * Architecture:
 ...
 * 
 * Commands:
 *   G0 X### F### - Rapid move to position
 *   G1 X### F### - Linear move to position
...
#include   // This is the ONLY include needed for ESP32 DevKit V1
